                ...
                <div class="container-fluid">
                	...
                	<div>
		                <ul class="nav nav-tabs" role="tablist">
		                    <li class="nav-item" role="presentation"><a class="nav-link active" role="tab" data-toggle="tab" href="http://127.0.0.1:8000/#tab-1">店家設定</a></li>
		                    <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" href="http://127.0.0.1:8000/#tab-2">設備配置</a></li>
		                    <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" href="http://127.0.0.1:8000/#tab-3">新增店家</a></li>
		                </ul>
		                <div class="tab-content">
		                    <div class="tab-pane active" role="tabpanel" id="tab-1">
														<div class="container">
																<h1 style="margin: 1rem 0 0 0.5rem;font-size: 1.2rem;font-weight: 900;">店家清單</h1>
...
<!--                 </div> -->
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
			  var hrefStr = $(e.target).attr("href") // activated tab
			  var 
			  alert(target);
			});
