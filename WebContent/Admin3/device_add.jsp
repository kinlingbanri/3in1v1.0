                ...
                <div class="container-fluid" id="divStoreConfig"">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary" style="float:left;">新增消費機</h4>
                            <button id="btnBack" type="button" class="btn btn-warning" style="margin-right:12px;; float:right;">確認新增</button>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
            												...
            												<input type="text" class="form-control configInput" id="inputDeviceName" style="margin-bottom: 6px;">
														    </div>
														    <div class="col-md configBlock">
														      	<h4 style="font-weight:900; margin-top: 6px; color:#FFCC22;">設備ID</h4>
            												<input type="text" class="form-control configInput" id="inputDeviceId" style="margin-bottom: 6px;">
														    </div>
														    <div class="col-md configBlock">
														      	<h4 style="font-weight:900; margin-top: 6px; color:#FFCC22;">類型</h4>
            												<div class="btn-group" style="display:block;">
																			  <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
																			  				aria-expanded="false" style="font-size: .9rem; height: 32px; margin-bottom: 6px;">
																			    選擇類型
																			  </button>
																			  <div class="dropdown-menu">
																			    <a class="dropdown-item" href="#">洗衣</a>
																			    <a class="dropdown-item" href="#">烘衣</a>
																			  </div>
																		</div>
														    </div>
