				...
				<div class="sign-in-htm" id="signin">
					...
					<div class="group">
						...
						<input id="password" type="password" class="input"
							...
							style="margin-top: 6px; font-size: 16px;"> <input
							id="texLogintPwd" type="text" class="input" name="texLogintPwd"
							style="margin-top: 6px; font-size: 16px;">
					</div>
					<div class="group" style="margin-bottom: 25px;">
						<label for="check"> <input type="checkbox" name="showPwd"
							id="checkboxPwd">顯示密碼
						</label>
					</div>
		...
		$("#registerBtn").click(function() {
							...
							if (state == 0) {
								...
								if (registerUsername == null
										|| registerUsername == "") {
									$("#registerUsername").val("帳號不能為空白!").css(
											'color', 'red');
								} else if (registerUsername == "此帳號已註冊!") {
