...
<%-- 												</c:choose> --%>
						...
						<div class="container" id="divMemberSetting" style="display:none;">
							<div class="row">
								...
								<div id="divDataTableAddvalue1" class="table-responsive">
					...
					success : function(jsonObject) { //當請求成功後此事件會被呼叫
						...
						if(state == 1){
							...
							var recordVOs = jsonObject["recordVOs"];
	 						...
	 						if(type == 1){
	 							$('#recordTable td:nth-child(1),th:nth-child(7)').hide();
							}else if(type ==2 ){
								$('#recordTable td:nth-child(1),th:nth-child(5)').hide();
								$('#recordTable td:nth-child(1),th:nth-child(6)').hide();
							}
	 						...
	 						for(var i = 0; i < count; i++){
									...
									console.log(time + ";" + storename + ";" + name + ";" + money + ";" + point + ";" + type);
									...
									cell1.innerHTML = '<tr><td style="text-align: center;">' + index + '</td></tr>';
									cell2.innerHTML = time;
									cell3.innerHTML = storename;
									cell4.innerHTML = name;
																		
									if(type == 1){
										cell5.innerHTML = money;
										cell6.innerHTML = point;
										cell7.innerHTML = '-';
// 										$('#recordTable td:nth-child(1),th:nth-child(7)').hide();
									}else if(type ==2 ){
										cell5.innerHTML = '-';
										cell6.innerHTML = '-';
										cell7.innerHTML = point;	
// 										$('#recordTable td:nth-child(1),th:nth-child(5)').hide();
// 										$('#recordTable td:nth-child(1),th:nth-child(6)').hide();
									}
