    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-top:4px;">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="./SingleConsumption.jsp" style="text-align: right; color: #FFFFFF;">消費服務<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
  	...
  	<input type="hidden" name="memVOPassword" value="<%=password %>" id="memVOPassword">
		...
		<div class="login-wrap" style="box-shadow: none;">
			<div class="login-html" style="background: none;">
				...
				<label for="tab-2" class="tab" style="font-size: 20px; font-weight:bold;">Email</label>
								<input id="tab-3" type="radio" name="tab" class="sign-up">
				<label for="tab-3" class="tab" style="font-size: 20px; font-weight:bold;">號碼</label>
